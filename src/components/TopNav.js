...
const TopNav = () => {
    return (
        <div style={{ padding: '0 25px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '75px', position: 'fixed', top: '0', left: '0', right: '0', backgroundColor: 'rgba(153, 153, 153, 0.8)' }}>
